...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Getting%20Started%20with%20BigQuery%20GIS%20for%20Data%20Analysts/hustlergsp866.sh
sudo chmod +x hustlergsp866.sh
./hustlergsp866.sh
```
