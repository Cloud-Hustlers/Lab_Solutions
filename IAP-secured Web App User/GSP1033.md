...
## 🚀 Securing Compute Engine Applications and Resources using Chrome Enterprise Premium | [GSP1033](http://cloudskillsboost.google/course_templates/784/labs/515002?locale=uk)
...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/IAP-secured%20Web%20App%20User/hustlergsp1033.sh
sudo chmod +x hustlergsp1033.sh
./hustlergsp1033.sh
```
