...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Using%20gsutil%20to%20Perform%20Operations%20on%20Buckets%20and%20Objects/hustlergsp130.sh
sudo chmod +x hustlergsp130.sh
./hustlergsp130.sh
```
