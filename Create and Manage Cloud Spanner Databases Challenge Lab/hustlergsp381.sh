...
chmod +x welcome.sh
./welcome.sh
wget https://raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/ed8351d0beeecc1302b039edefc2f4a2d13edf5f/Create%20and%20Manage%20Cloud%20Spanner%20Databases%20Challenge%20Lab/Customer_List_500.csv
...
gcloud dataflow jobs run hustler --gcs-location gs://dataflow-templates-us-west1/latest/GCS_Text_to_Cloud_Spanner --region us-west1 --staging-location gs://$DEVSHELL_PROJECT_ID/tmp/ --parameters instanceId=banking-ops-instance,databaseId=banking-ops-db,importManifest=gs://$DEVSHELL_PROJECT_ID/manifest.json
