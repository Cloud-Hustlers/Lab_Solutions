...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/APIs%20Explorer%20Create%20and%20Update%20a%20Cluster/hustlergsp288.sh
sudo chmod +x hustlergsp288.sh
./hustlergsp288.sh
```
