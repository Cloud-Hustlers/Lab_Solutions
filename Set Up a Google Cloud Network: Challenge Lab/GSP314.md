...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Set%20Up%20a%20Google%20Cloud%20Network%3A%20Challenge%20Lab/hustlergsp314.sh
sudo chmod +x hustlergsp314.sh
./hustlergsp314.sh
```
