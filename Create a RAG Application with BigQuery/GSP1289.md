...
## 🚀 Create a RAG Application with BigQuery | [GSP1289](https://www.cloudskillsboost.google/focuses/115681?parent=catalog)
...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Create%20a%20RAG%20Application%20with%20BigQuery/hustlergsp1289.sh
sudo chmod +x hustlergsp1289.sh
./hustlergsp1289.sh
```
