...
# 🚀 Arcade Hero: Enter the Cloud Function PHP | [ARC233](https://www.cloudskillsboost.google/catalog_lab/31634)

### 🔗 **Solution Video:** [Watch Here ](https://youtu.be/2G1DzPGEh_c)
...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Arcade%20Hero/hustlerarc233.sh

sudo chmod +x hustlerarc233.sh
