...
# Using the Google Cloud Speech API: Challenge Lab || [ARC131](https://www.cloudskillsboost.google/course_templates/756/labs/475242) ||
...
```
curl -LO https://raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Using%20the%20Google%20Cloud%20Speech%20API%20Challenge%20Lab/hustler131.sh
sudo chmod +x hustler131.sh
./hustler131.sh
```
