...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Google%20Kubernetes%20Engine%20Pipeline%20using%20Cloud%20Build/hustlergsp1077.sh
sudo chmod +x hustlergsp1077.sh
./hustlergsp1077.sh
```
