...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Data%20Catalog%20Qwik%20Start/hustlergsp729.sh
sudo chmod +x hustlergsp729.sh
./hustlergsp729.sh
```
