...
```bash
curl -LO https://raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Cloud%20SQL%20for%20PostgreSQL%20Qwik%20Start/hustlergsp152.sh
sudo chmod +x hustlergsp152.sh
./hustlergsp152.sh
```
