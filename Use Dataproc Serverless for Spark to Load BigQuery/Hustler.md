...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Use%20Dataproc%20Serverless%20for%20Spark%20to%20Load%20BigQuery/hustler.sh
```
