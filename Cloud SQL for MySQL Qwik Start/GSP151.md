...
```bash
curl -LO https://raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Cloud%20SQL%20for%20MySQL%20Qwik%20Start/hustlergsp151.sh
sudo chmod +x hustlergsp151.sh
./hustlergsp151.sh
```
