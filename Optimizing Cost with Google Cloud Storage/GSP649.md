...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Optimizing%20Cost%20with%20Google%20Cloud%20Storage/hustlergsp649.sh
sudo chmod +x hustlergsp649.sh
./hustlergsp649.sh
```
