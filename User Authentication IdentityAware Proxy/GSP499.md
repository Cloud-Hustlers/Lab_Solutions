...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/User%20Authentication%20IdentityAware%20Proxy/hustlergsp499.sh
```
