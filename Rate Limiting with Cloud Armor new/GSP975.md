...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Rate%20Limiting%20with%20Cloud%20Armor%20new/hustlergsp975.sh
sudo chmod +x hustlergsp975.sh
./hustlergsp975.sh
```
