...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Detect%20Manufacturing%20Defects%20using%20Visual%20Inspection%20AI%20Challenge%20Lab/hustlergsp366.sh
sudo chmod +x hustlergsp366.sh
./hustlergsp366.sh
```
