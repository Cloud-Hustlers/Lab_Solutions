...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/HTTP%20Google%20Cloud%20Functions%20in%20Go/hustlergsp602.sh
sudo chmod +x hustlergsp602.sh
./hustlergsp602.sh
```
