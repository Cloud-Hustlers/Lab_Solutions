...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Deploy%20Microsoft%20SQL%20Server%20to%20Compute%20Engine/hustlergsp031.sh

sudo chmod +x hustlergsp031.sh
