...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Build%20a%20Serverless%20Web%20App%20with%20Firebase/hustlergsp643.sh

source hustlergsp643.sh
```
