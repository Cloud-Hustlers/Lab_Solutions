...
## 🚀 De-identify DICOM Data with the Healthcare API | [GSP626](https://www.cloudskillsboost.google/focuses/6920?parent=catalog)
...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Deidentify%20DICOM%20Data%20with%20the%20Healthcare%20API/hustlergsp626.sh
sudo chmod +x hustlergsp626.sh
./hustlergsp626.sh
```
