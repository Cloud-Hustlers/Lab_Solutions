...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Distributed%20Load%20Testing%20Using%20Kubernetes/hustlergsp182.sh
```
