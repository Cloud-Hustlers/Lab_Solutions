...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Modular%20Load%20Balancing%20with%20Terraform%20Regional%20Load%20Balancer/hustlergsp191.sh

sudo chmod +x hustlergsp191.sh
