...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Loading%20Your%20Own%20Data%20into%20BigQuery/hustlergsp865.sh
sudo chmod +x hustlergsp865.sh
./hustlergsp865.sh
```
