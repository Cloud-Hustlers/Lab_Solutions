...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Using%20Prometheus%20for%20Monitoring%20on%20Google%20Cloud%20Qwik%20Start/hustlergsp1024.sh
sudo chmod +x hustlergsp1024.sh
./hustlergsp1024.sh
```
