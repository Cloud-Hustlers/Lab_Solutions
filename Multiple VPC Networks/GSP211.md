...
```bash
curl -LO https://raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Multiple%20VPC%20Networks/hustlergsp211.sh

sudo chmod +x hustlergsp211.sh
