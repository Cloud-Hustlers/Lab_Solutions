...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Cloud%20Operations%20for%20GKE/hustlergsp497.sh
sudo chmod +x hustlergsp497.sh
./hustlergsp497.sh
```
