...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Log%20Analytics%20on%20Google%20Cloud/hustlergsp1088.sh
sudo chmod +x hustlergsp1088.sh
./hustlergsp1088.sh
```
