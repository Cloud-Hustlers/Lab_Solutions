...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Analyze%20Customer%20Reviews%20with%20Gemini%20Using%20SQL/hustlergsp1246.sh
sudo chmod +x hustlergsp1246.sh
./hustlergsp1246.sh
```
