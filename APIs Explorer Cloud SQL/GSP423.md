...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/APIs%20Explorer%20Cloud%20SQL/hustlergsp423.sh
sudo chmod +x hustlergsp423.sh
./hustlergsp423.sh
```
