...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/APIs%20Explorer%20App%20Engine/hustlergsp422.sh
sudo chmod +x hustlergsp422.sh
./hustlergsp422.sh
```
