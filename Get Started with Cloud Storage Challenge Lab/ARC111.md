...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Get%20Started%20with%20Cloud%20Storage%20Challenge%20Lab/hustlerarc111.sh

sudo chmod +x hustlerarc111.sh
