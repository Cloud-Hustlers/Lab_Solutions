...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Cloud%20Data%20Loss%20Prevention%20API%20Qwik%20Start/hustlergsp107.sh

sudo chmod +x hustlergsp107.sh
