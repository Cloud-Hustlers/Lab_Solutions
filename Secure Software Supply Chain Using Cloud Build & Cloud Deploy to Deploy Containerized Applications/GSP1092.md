...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Secure%20Software%20Supply%20Chain%20Using%20Cloud%20Build%20%26%20Cloud%20Deploy%20to%20Deploy%20Containerized%20Applications/hustlergsp1092.sh
sudo chmod +x hustlergsp1092.sh
./hustlergsp1092.sh
```
