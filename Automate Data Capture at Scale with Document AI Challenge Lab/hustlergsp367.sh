...
while [ "$deploy_success" = false ]; do
  if deploy_function; then
    echo "Function deployed successfully, Don't forgot to subscribe to hustler:)(https://www.youtube.com/@CloudHustlers)"
    deploy_success=true
  else
    echo "Deployment Retrying, please subscribe to hustler (https://www.youtube.com/@CloudHustlers).."
    sleep 10
  fi
done
