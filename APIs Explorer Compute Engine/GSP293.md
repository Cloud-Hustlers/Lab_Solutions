...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/APIs%20Explorer%20Compute%20Engine/hustlergsp293.sh
sudo chmod +x hustlergsp293.sh
./hustlergsp293.sh
```
