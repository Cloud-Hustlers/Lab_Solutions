...
## 🚀 Scaling Microservices Applications: Migration to Redis Enterprise on Google Cloud | [GSP1177](https://www.cloudskillsboost.google/focuses/74654?parent=catalog)
...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Scaling%20Microservices%20Applications%3A%20Migration%20to%20Redis%20Enterprise%20on%20Google%20Cloud/hustlergsp1177.sh
sudo chmod +x hustlergsp1177.sh
./hustlergsp1177.sh
```
