...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Getting%20Started%20with%20Cloud%20Shell%20and%20gcloud/hustlergsp002.sh
sudo chmod +x hustlergsp002.sh
./hustlergsp002.sh
```
