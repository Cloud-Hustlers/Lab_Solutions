...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Securing%20Container%20Builds/hustlergsp1185.sh
```
...
```bash
sudo chmod +x hustlergsp1185.sh
```
