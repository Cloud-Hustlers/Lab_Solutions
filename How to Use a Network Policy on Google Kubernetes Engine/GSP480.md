...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/How%20to%20Use%20a%20Network%20Policy%20on%20Google%20Kubernetes%20Engine/hustlergsp480.sh
sudo chmod +x hustlergsp480.sh
./hustlergsp480.sh
```
