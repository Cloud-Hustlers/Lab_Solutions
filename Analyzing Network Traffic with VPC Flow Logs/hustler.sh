...
echo -e " ${BOLD_RED}Firewall:${RESET} ${BOLD_GREEN}https://console.cloud.google.com/net-security/firewall-manager/firewall-policies/details/allow-http-ssh?project=${RESET}"

echo ""

echo -e " ${BOLD_RED}Logging:${RESET} ${BOLD_GREEN}https://console.cloud.google.com/logs/query;cursorTimestamp=2024-10-16T16:41:23.858885Z;duration=PT1H?_ga=2.159612541.1373851212.1717364279-1768117806.1717363789&_gac=1.212068896.1717364364.EAIaIQobChMIx4iR4fC9hgMV4A6DAx1fJjJvEAAYAiAAEgKTZvD_BwE%5C033%5B0m&project=qwiklabs-gcp-04-299e6c5206ea&supportedpurview=folder,organizationId,project${RESET}"
