...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Introduction%20to%20Cloud%20Dataproc%20Hadoop%20and%20Spark%20on%20Google%20Cloud/hustlergsp123.sh
sudo chmod +x hustlergsp123.sh
./hustlergsp123.sh
```
