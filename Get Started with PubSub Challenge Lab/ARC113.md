...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Get%20Started%20with%20PubSub%20Challenge%20Lab/newhustlerarc113.sh

sudo chmod +x newhustlerarc113.sh
