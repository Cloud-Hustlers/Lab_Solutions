...
for cluster in "${CLUSTERS[@]}"; do
  ...
  while [ "$status" != "RUNNING" ]; do
    ...
    echo "Like Share and Subscribe to CLOUDHUSTLERS [https://www.youtube.com/@CloudHustlers]..."
...
while true; do
  ...
  echo "it's creating now so kindly wait meanwhile like share and subscribe to hustler [https://www.youtube.com/@CloudHustlers]"
