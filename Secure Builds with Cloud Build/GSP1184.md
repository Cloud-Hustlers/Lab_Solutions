...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Secure%20Builds%20with%20Cloud%20Build/hustlergsp1184.sh
```
...
```bash
sudo chmod +x hustlergsp1184.sh
```
