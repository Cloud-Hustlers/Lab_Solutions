...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Create%20a%20Streaming%20Data%20Lake%20on%20Cloud%20Storage%20Challenge%20Lab/hustlerarc110.sh
sudo chmod +x hustlerarc110.sh
./hustlerarc110.sh
```
