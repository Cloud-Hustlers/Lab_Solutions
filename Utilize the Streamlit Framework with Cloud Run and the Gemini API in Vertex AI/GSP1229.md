...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Utilize%20the%20Streamlit%20Framework%20with%20Cloud%20Run%20and%20the%20Gemini%20API%20in%20Vertex%20AI/hustlergsp1229.sh
sudo chmod +x hustlergsp1229.sh
./hustlergsp1229.sh
```
