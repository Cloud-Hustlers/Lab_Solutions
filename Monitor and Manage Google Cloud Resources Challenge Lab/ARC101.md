...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Monitor%20and%20Manage%20Google%20Cloud%20Resources%20Challenge%20Lab/hustlerarc101.sh
sudo chmod +x hustlerarc101.sh
./hustlerarc101.sh
```
