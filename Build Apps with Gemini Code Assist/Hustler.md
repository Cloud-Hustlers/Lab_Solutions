...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Build%20Apps%20with%20Gemini%20Code%20Assist/task1.sh
...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Build%20Apps%20with%20Gemini%20Code%20Assist/task2.sh
source task2.sh
```
