...
## 🚀 Cloud Run Functions: Qwik Start - Console | [GSP1089](https://www.cloudskillsboost.google/focuses/1763?parent=catalog)
...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Cloud%20Run%20Functions%20Qwik%20Start%20Console/newhustlergsp081.sh

sudo chmod +x newhustlergsp081.sh
