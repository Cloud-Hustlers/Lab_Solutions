...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Using%20Cloud%20Trace%20on%20Kubernetes%20Engine/hustlergsp484.sh
sudo chmod +x hustlergsp484.sh
./hustlergsp484.sh
```
