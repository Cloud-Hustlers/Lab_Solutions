...
## 🚀 Build Google Cloud Infrastructure for AWS Professionals: Challenge Lab | [GSP511](https://www.cloudskillsboost.google/focuses/60389?parent=catalog)
...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Build%20Google%20Cloud%20Infrastructure%20for%20AWS%20Professionals%20Challenge%20Lab/hustlergsp511.sh
sudo chmod +x hustlergsp511.sh
./hustlergsp511.sh
```
