...
```bash
curl -LO https://raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Cloud%20Natural%20Language%20API%20Qwik%20Start/hustlergsp097.sh
sudo chmod +x hustlergsp097.sh
./hustlergsp097.sh
```
