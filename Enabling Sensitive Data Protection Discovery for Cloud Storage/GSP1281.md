...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Enabling%20Sensitive%20Data%20Protection%20Discovery%20for%20Cloud%20Storage/hustlergsp1281.sh
sudo chmod +x hustlergsp1281.sh
./hustlergsp1281.sh
```
