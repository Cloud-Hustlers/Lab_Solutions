...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Use%20Machine%20Learning%20APIs%20on%20Google%20Cloud%20Challenge%20Lab/hustlergsp329.sh
sudo chmod +x hustlergsp329.sh
./hustlergsp329.sh
```
