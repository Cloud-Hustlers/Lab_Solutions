...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Deploy%20a%20Compute%20Instance%20with%20a%20Remote%20Startup%20Script%20Challenge%20Lab/hustlergsp301.sh
sudo chmod +x hustlergsp301.sh
./hustlergsp301.sh
```
