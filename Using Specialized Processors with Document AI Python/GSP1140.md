...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Using%20Specialized%20Processors%20with%20Document%20AI%20Python/hustlergsp1140.sh
sudo chmod +x hustlergsp1140.sh
./hustlergsp1140.sh
```
