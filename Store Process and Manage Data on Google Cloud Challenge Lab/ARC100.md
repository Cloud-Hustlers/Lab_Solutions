...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Store%20Process%20and%20Manage%20Data%20on%20Google%20Cloud%20Challenge%20Lab/hustlerarc100.sh
sudo chmod +x hustlerarc100.sh
./hustlerarc100.sh
```
