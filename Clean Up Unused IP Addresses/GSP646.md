...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Clean%20Up%20Unused%20IP%20Addresses/hustlergsp646.sh

sudo chmod +x hustlergsp646.sh
