...
curl -LO https://raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Adding%20a%20Phone%20Gateway%20to%20a%20Virtual%20Agent/pigeon-travel-gsp-793-cloud-function/index.js
curl -LO https://raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Adding%20a%20Phone%20Gateway%20to%20a%20Virtual%20Agent/pigeon-travel-gsp-793-cloud-function/package.json
...
while true; do
  ...
  if gcloud functions describe $SERVICE_NAME --region $REGION &> /dev/null; then
    ...
    echo "Meantime Subscribe to CloudHustlers[https://www.youtube.com/@CloudHustlers]."
    sleep 10
  fi
done
