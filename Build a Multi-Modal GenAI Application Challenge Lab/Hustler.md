...
```bash,copy,run
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Build%20a%20Multi-Modal%20GenAI%20Application%20Challenge%20Lab/hustler.sh
source hustler.sh
```
