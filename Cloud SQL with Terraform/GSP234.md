...
```bash
curl -LO https://raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Cloud%20SQL%20with%20Terraform/hustlergsp234.sh
sudo chmod +x hustlergsp234.sh
./hustlergsp234.sh
```
