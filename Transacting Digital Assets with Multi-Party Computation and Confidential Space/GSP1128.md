...
## 🚀 Transacting Digital Assets with Multi-Party Computation and Confidential Space | [GSP1128](https://www.cloudskillsboost.google/focuses/61481?parent=catalog)
...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/master/Transacting%20Digital%20Assets%20with%20Multi-Party%20Computation%20and%20Confidential%20Space/hustlergsp1128.sh
```
...
```bash
sudo chmod +x hustlergsp1128.sh
```
