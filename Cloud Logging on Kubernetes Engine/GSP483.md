...
```bash
curl -LO https://raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Cloud%20Logging%20on%20Kubernetes%20Engine/hustlergsp483.sh
sudo chmod +x hustlergsp483.sh
./hustlergsp483.sh
```
