...
```bash
curl -LO raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Connect%20an%20App%20to%20a%20Cloud%20SQL%20for%20PostgreSQL%20Instance/hustlergsp919.sh
sudo chmod +x hustlergsp919.sh
./hustlergsp919.sh
```
---
