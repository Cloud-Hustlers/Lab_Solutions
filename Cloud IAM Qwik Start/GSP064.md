...
```bash
curl -LO https://raw.githubusercontent.com/Cloud-Hustlers/Lab_Solutions/refs/heads/main/Cloud%20IAM%20Qwik%20Start/hustlergsp064.sh
sudo chmod +x hustlergsp064.sh
./hustlergsp064.sh
```
